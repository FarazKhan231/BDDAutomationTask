...
import com.Test.Faraz.PageObjects.Header;
import com.Test.Faraz.PageObjects.MyAccountPage;
import com.Test.Faraz.PageObjects.OrderHistoryPage;
import com.Test.Faraz.PageObjects.PersonalInfoSavedSuccessPage;
import com.Test.Faraz.PageObjects.PersonalInformationPage;
...
public class MyAccountSteps {
	...
	public void iUpdateMyFirstNameTo(String firstName) throws Throwable {
		personalInfoSavedSuccessPage = personInfoPage.EnterFirstName(firstName).EnterOldPassword(TestBase.Password)
				.SavePersonInfo();
	}
